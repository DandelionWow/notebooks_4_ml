...
问题1：GMF、MLP和NeuMF的loss都是用的是二值交叉熵，在代码的哪里体现的？
![picture 16](assets/images/1682167533074.png)  

问题2：这个预测因素（the number of predictive factors, 代码中是num_factors，用于Embedding时的output_dim了）到底是什么？

问题3：如果使用预训练，代码中优化器并没有切换到SGD。